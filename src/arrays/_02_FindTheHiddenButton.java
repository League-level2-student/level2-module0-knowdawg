...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String answerString = JOptionPane.showInputDialog("Enter a posative number");
		...
		for (int i = 0; i < answer; i++) {
			...
			buttons[i].setSize(answer, answer);
		...
		JOptionPane.showMessageDialog(null, "Click the button with ME on it.");
		
		//13. initialize the hiddenButton variable to a random number less than the int created int step 3
		Random randy = new Random();
		int hiddenButton = randy.nextInt(answer);
